...
export default async function Home() {
  ...
  // Allow public access to product catalog - no authentication required
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950 dark:via-purple-950 dark:to-pink-950 py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center space-y-6">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
                #1 for Bulk Orders in the USA
              </p>
              <p className="text-lg text-muted-foreground max-w-xl mx-auto">
                Premium quality custom embroidered or printed graduation stoles at wholesale prices. 
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Choose Your Stole Type
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Select from our three premium stole types, each designed to meet different needs and budgets
              </p>
            </div>
